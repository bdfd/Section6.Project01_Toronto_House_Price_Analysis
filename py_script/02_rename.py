...
folder = os.chdir(os.path.dirname()))
print("Current working directory: {0}".format(folder))

# print("Current working directory: {0}".format(cwd))
# folder_location = os.chdir('../data/test')
# print("Current working directory: {0}".format(folder_location))
# for f in os.path.exists(folder_location):
#     print(f)
